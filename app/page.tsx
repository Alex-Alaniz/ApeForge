        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            <div className="flex justify-center mb-4">
              <InteractiveParticleText text="APEFORGE" size="large" color="white" hoverColor="#3b82f6" />
            </div>
            <h2 className="text-2xl md:text-3xl font-light">Forging the future of ApeChain</h2>
          </div>
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
              {slides.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full ${index === currentSlide ? "bg-blue-500" : "bg-white/50"}`}
